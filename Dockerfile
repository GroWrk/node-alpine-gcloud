...
RUN apk add --no-cache bash ca-certificates curl git openssh-client python3 tar gzip
...
RUN google-cloud-sdk/install.sh --path-update=true --bash-completion=true --rc-path=/root/.bashrc
